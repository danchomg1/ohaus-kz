...
| Файл                        | Где                                     |
| --------------------------- | --------------------------------------- |
| `hero-explorer.jpg`         | Hero, слайд Explorer™ EX                |
| `hero-adventurer.jpg`       | Hero, слайд Adventurer™ AX              |
| `hero-pioneer.jpg`          | Hero, слайд Pioneer™ PX                 |
| `hero-scout.jpg`            | Hero, слайд Scout™                      |
...
Все — фирменные снимки OHAUS с ru.ohaus.com. Для Hero специально выбраны кадры
**без вшитого текста**: у части снимков на их сайте поверх фото напечатаны
английские слоганы («INTELLIGENT PERFORMANCE», «ECONOMY & ACCURACY») — на тёмном
баннере рядом с русским заголовком они смотрятся чужеродно.
