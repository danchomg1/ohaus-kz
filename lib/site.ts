...
export const SITE_DESCRIPTION =
  "Официальное представительство OHAUS в Казахстане: лабораторные и промышленные весы, анализаторы влажности, центрифуги, шейкеры, гири. Подбор оборудования, поставка и сервис.";
